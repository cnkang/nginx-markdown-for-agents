...
response that is eligible for conversion but blocked from streaming is
converted with the full-buffer engine; a response that is not eligible for
conversion is forwarded unchanged. Use
