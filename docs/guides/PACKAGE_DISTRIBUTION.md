...
|-------|-------------|---------|
| VERSION | Module semantic version | 0.9.0 |
...
```bash
curl -fsSLO https://github.com/<org>/nginx-markdown-for-agents/releases/download/v0.9.0/SHA256SUMS
```
...
sha256sum nginx-module-markdown-for-agents_0.9.0_nginx-1.26.3_amd64.deb

# Compare the output against the corresponding line in SHA256SUMS
grep "nginx-module-markdown-for-agents_0.9.0_nginx-1.26.3_amd64.deb" SHA256SUMS
```
...
```text
a1b2c3d4...  nginx-module-markdown-for-agents_0.9.0_nginx-1.26.3_amd64.deb
e5f6a7b8...  nginx-module-markdown-for-agents-0.9.0-nginx1.26.3-1.x86_64.rpm
...
curl -fsSL -H "Accept: application/json" -o release-manifest.json \
  https://github.com/<org>/nginx-markdown-for-agents/releases/download/v0.9.0/release-manifest.json
```
...
curl -fsSLO https://github.com/<org>/nginx-markdown-for-agents/releases/download/v0.9.0/SHA256SUMS
curl -fsSLO https://github.com/<org>/nginx-markdown-for-agents/releases/download/v0.9.0/SHA256SUMS.asc
curl -fsSLO https://github.com/<org>/nginx-markdown-for-agents/releases/download/v0.9.0/<package-file>
curl -fsSLO https://github.com/<org>/nginx-markdown-for-agents/releases/download/v0.9.0/release-manifest.json
