...
| 1.24.0 | legacy | ubuntu-24.04 | glibc | arm64 | dynamic-module | smoke-test | best-effort | No | `.github/workflows/release-packages.yml` |
| 1.24.0 | legacy | ubuntu-24.04 | glibc | amd64 | dynamic-module | smoke-test | best-effort | No | `.github/workflows/release-packages.yml` |
