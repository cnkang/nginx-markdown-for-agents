...
v0.9.1 was released on 2026-07-28 and is the current stable release line.
Review the [0.9.x migration guide](../guides/MIGRATION-0.9.md) before upgrading
from an earlier release; source builders must also meet the Rust baseline
described below.
