...
- Performance evidence: the module benchmark harness exercises 7 scenarios
  ...
  decompression.  Each compressed path provides independent per-codec
  `decompression_streaming_total` or `decompression_fullbuffer_total` evidence
  from a real module-enabled NGINX.
