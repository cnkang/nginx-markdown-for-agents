...
prebuilt artifacts do not need to install Rust. Configuration and ABI migration
steps introduced by the final baseline audit are listed in this section as
they are completed; do not treat this release-candidate document as a claim
that v0.9.1 has already been published.
