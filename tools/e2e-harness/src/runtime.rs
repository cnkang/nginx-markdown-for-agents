...
impl RuntimeMode {
    ...
    /// Return the NGINX binary path if this is `RuntimeMode::Reuse`.
    ...
    /// Return `true` when operating in `RuntimeMode::Reuse`.
...
fn write_nginx_conf_stub(
    ...
    let content = match scenario_name {
        "brotli-streaming" => brotli_nginx_conf(
            &error_log,
            &access_log,
            &pid_path,
            nginx_bin,
        ...
        "conditional-requests" => conditional_nginx_conf(
            &error_log,
            &access_log,
            &pid_path,
            nginx_bin,
        ...
        "auth-cache" => auth_cache_nginx_conf(
            &error_log,
            &access_log,
            &pid_path,
            nginx_bin,
        ...
        "accept-negotiation" => accept_negotiation_nginx_conf(
            &error_log,
            &access_log,
            &pid_path,
            nginx_bin,
        ...
        "status-codes" => status_codes_nginx_conf(
            &error_log,
            &access_log,
            &pid_path,
            nginx_bin,
...
fn accept_negotiation_nginx_conf(
    error_log: &Path,
    access_log: &Path,
    pid_path: &Path,
    nginx_bin: &Path,
    ...
    server {{\n\
        ...
        location /streaming/ {{\n\
            ...
            markdown_limits conversion_memory=64m conversion_timeout=120s parser_timeout=120s\n\
                streaming_buffer=64m decompression_ratio=10000;\n\
            markdown_error_policy pass;\n\
        ...
        location /tight-budget/ {{\n\
            ...
            markdown_cache_validation off;\n\
            markdown_limits conversion_memory=64m conversion_timeout=120s\n\
                streaming_buffer=64m decompressed_size=64k;\n\
            markdown_error_policy pass;\n\
            proxy_pass http://fixture_backend/;\n\
        }}\n\
        location = /markdown-metrics {{ markdown_metrics; }}\n\
