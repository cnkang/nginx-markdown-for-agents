...
#: Live image refs from the detector helper, for tests that validate detector
#: *behavior* (not manifest values).
from harness.detect_release_supply_chain import builder_image_refs  # noqa: E402 - detector helper

ALMALINUX_9, ALPINE_320 = builder_image_refs()
