...
| 10 | parser-regex | No overlapping quantifiers; prefer deterministic parsing; AST-based detection with scope-aware binding model and shell argument semantics via `make regex-security-check` |
