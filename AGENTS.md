...
| 61 | release-integrity | Performance evidence provenance invariant: every scenario record accepted by the release gate must carry all seven provenance fields (source_git_commit, source_workflow_run/attempt, source_artifact/digest, measurement_timestamp, source_environment); fail closed on missing fields or mixed-environment baselines |
