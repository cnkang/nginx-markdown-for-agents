...
# -MMD -MP emits per-target dependency files so editing an src/ file that a
# unit test #includes directly (`#include "../../src/*.c"`) still rebuilds it.
CFLAGS_COMMON ?= -Wall -Wextra -Werror=implicit-function-declaration -Werror=incompatible-pointer-types -g -std=$(CSTD) -Iinclude -I../../rust-converter/include -MMD -MP
LDFLAGS_COMMON ?=
