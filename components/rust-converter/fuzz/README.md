...
- **Storage**: `fuzz/corpus/<target>/` (e.g., `fuzz/corpus/convert_html/`)
...
- **Maintenance**: No manual intervention needed; prune workflow automatically
  maintains the minimal coverage set

#### Crash Artifacts

Input files that triggered crashes, automatically uploaded by CI fuzzing
workflows when issues are discovered.
...
- **Access**: CI system
- **Maintenance**: No manual intervention needed; automatically maintained by
  ClusterFuzzLite
