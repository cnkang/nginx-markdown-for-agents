...
// Source SHA-256: aa67c062dcc8768155db2b915f7a50e511f2480bb7cf2cdb7d9453559be3207d
//
...
impl ReasonCode {
    ...
    /// assert_eq!(ReasonCode::from_discriminant(25), None);
    /// ```
    pub fn from_discriminant(value: u32) -> Option<Self> {
        match value {
            ...
            21 => Some(ReasonCode::HeaderPlanApplyError),
            22 => Some(ReasonCode::StreamingMidFlightError),
            23 => Some(ReasonCode::BypassNoTransform),
            24 => Some(ReasonCode::EncodingHeaderInvalid),
            _ => None,
        }
    }
}
